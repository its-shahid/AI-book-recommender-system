...
def load_data():
    ...
    # Rename columns only if old names still exist (bug fix)
    rename_map = {
        'Book-Title':  'title',
...
# ─────────────────────────────────────────────
# Rule-based Explanation (No API - 100% Free)
# ─────────────────────────────────────────────
def get_explanation(selected_book, recommended_books):
    ...
    return (
        ...
        f"These books share similar themes, writing style, or target audience with your selected book. "
        f"This recommendation is powered by Collaborative Filtering using the K-Nearest Neighbors algorithm."
    )
...
if show:
    ...
    # Skip index 0 (input book itself), show 1 to 5
